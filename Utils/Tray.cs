...
//http://blogs.msdn.com/delay/archive/2009/08/31/get-out-of-the-way-with-the-tray-minimize-to-tray-sample-implementation-for-wpf.aspx
namespace Utils
{
    /// <summary>
    ...
    public static class Tray
    {
        ...
        private class MinimizeToTrayInstance : IDisposable
        {
            ...
            {
                StateHandler = new EventHandler(HandleStateChanged);

                _window = window;
                _window.StateChanged += StateHandler;
            }
