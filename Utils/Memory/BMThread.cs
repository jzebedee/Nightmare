    ...
    sealed public partial class BlackMagic
    {
        ...
        public uint Execute(uint dwStartAddress, uint dwParameter)
        {
            ...
            if (hThread == IntPtr.Zero)
                throw new MemoryOperationFailedException("Thread could not be remotely created.");
            ...
            if (!bSuccess)
                throw new MemoryOperationFailedException("Error waiting for thread to exit or getting exit code.");
