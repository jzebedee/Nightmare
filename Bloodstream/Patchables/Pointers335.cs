namespace xWow.Lib.Pointers //3.3.5
{
    public static class Misc
    {
        public const uint
            ...
            InGame = 0x00BD078A;                //3.3.5 | CGGameUI__EnterWorld | .text:005288B7 mov     byte_BD078A, 1
    }
    public static class LocalPlayer
    {
        public const uint //pet spellbook comes after localplayer spellbook block
            SpellBookCount = 0x00BE8D94,    //3.3.5 | CGSpellBook__UpdateSpells | .text:0053D603 mov     dword_BE8D94, eax
            SpellBook = 0x00BE5D80,         //3.3.5 | CGSpellBook__UpdateSpells | .text:0053D5F9 mov     dword_BE5D80[eax*4], ecx
            RuneTypes = 0x00C242FC,         //3.3.5 | lua_GetRuneType
            RuneCooldowns = 0x00C2435C,     //3.3.5 | lua_GetRuneCooldown
            ComboPoints = 0x00C4EBE5;       //3.3.3a
    }
    public static class Zone
    {
        public const uint
            ...
            WorldMap = 0x00CE06C8; //3.3.5 | CMap__Load | .text:007C013D push    offset unk_CE06C8
    }
    ...
    {
        public const uint
            ClientDBRegisterBase = 0x00633A50; //3.3.5
    }
