namespace xBot.Patchables //3.3.5a
{
    ...
    public enum LocalPlayerExtras : uint
    {
        ...
        SpellBookCount = 0x00BE8D9C,    //3.3.5a | CGSpellBook__UpdateSpells | .text:0053CCE3 mov     dword_BE8D9C, eax
        SpellBook = 0x00BE5D88,         //3.3.5a | CGSpellBook__UpdateSpells | .text:0053CCD9 mov     dword_BE5D88[eax*4], ecx
        RuneTypes = 0x00C24304,         //3.3.5a | lua_GetRuneType
        RuneCooldowns = 0x00C24364,     //3.3.5a | lua_GetRuneCooldown
        ComboPoints = 0x00BD084D,       //3.3.5a | lua_GetComboPoints
    }
    ...
    {
        TransportGUID = 0x790, //3.3.5a
        Location = 0x798, //3.3.5a
        Casting = 0xA6C, //3.3.5a
        ChanneledCasting = 0xA80, //3.3.5a
        AttackedGUID = 0xA20, //3.3.5a | lua_StopAttack | .text:0051D0DD call    CGUnit_C__GuidA20_Is_NonZero(0071AF90) | .text:0071AF90 mov     eax, [ecx+0A20h]
    ...
    public enum UnitAuras : uint //3.3
    {
        AURA_COUNT_1 = 0xDD0,
        AURA_COUNT_2 = 0xC54,
        AURA_TABLE_1 = 0xC50,
    ...
    public enum Position : uint
    {
        ...
        TransportMatrix = 0x1a8, //3.3.5a
    }
    public enum UnitName : uint
    {
        ObjectName1 = 0x1A4,
        ObjectName2 = 0x90,
        UnitName1 = 0x964,
    ...
    {
        ClientDBRegisterBase = 0x006337D0, //3.3.5a
